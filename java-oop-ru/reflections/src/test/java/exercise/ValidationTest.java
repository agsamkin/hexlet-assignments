...
class ValidationTest {
    ...
    void testAdvancedValidate() {
        Address address1 = new Address("Russia", "Ufa", "Lenina", "5456", null);
        ...
        Map<String, List<String>> expected2 = Map.of("country", List.of("can not be null"), "houseNumber", List.of("length less than 4"));
        assertThat(result2).isEqualTo(expected2);
    }
    // END
}
